...
import { deleteCategory, ensureDefaultCategories, getCategoryById, reassignAssetCategory } from "../../services/cosmos.js";
export async function deleteCategoryHandler(request, context) {
    try {
