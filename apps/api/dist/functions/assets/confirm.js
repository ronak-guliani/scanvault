...
import { ensureCategoryBySlug, getAssetById, getOrCreateUserSettings, markAssetFailed, upsertAsset } from "../../services/cosmos.js";
...
export async function confirmUploadHandler(request, context) {
    try {
        ...
        if (body.extracted) {
            ...
            const normalizedBlobUrls = asset.normalizedBlobUrls.length > 0 ? asset.normalizedBlobUrls : [asset.originalBlobUrl];
            const readyAsset = {
                ...asset,
                normalizedBlobUrls,
