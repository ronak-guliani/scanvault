...
async function waitForAuthCode(port, expectedState, timeoutMs) {
...
export function registerLoginCommand(program) {
    program
        ...
        const expiresAt = typeof token.expiresIn === "number" ? new Date(Date.now() + token.expiresIn * 1000).toISOString() : undefined;
        await setCredentials({
